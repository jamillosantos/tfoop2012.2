...
{
	/**
	 * Guarda as inst�ncias de todos os modelos <T> criados.
	 */
	...
	/**
	 * @return Retorna o inteiro identificador do �ltimo objeto inserido.
	 */
	...
	/**
	 * Cria e retorna a inst�ncia da lista que ser� utilizada pela
	 * vari�vel models.
	 * 
	 * @see foodlink.models
	 * @return
